...
//   course: "AI & DS"
// };
// console.log(student.name);  // pravin raj


const students = [
  { name: "Naveen", age: 20, grade: "A" },
  { name: "Kumar", age: 21, grade: "B" },
  { name: "Pravin raj", age: 19, grade: "A+" }
];
...
let names1=stud.filter(f=>f.marks>50).map(n=>n.name);
console.log(names1); 
const
    person={    
    name:"pravin",
